...
//判断用户是否登录
if(isset($_COOKIE['id'])){
    echo "<script>alert('抱歉，您已登录，无需重复登录！');window.location.href='index.html'</script>";
    die;
}
?>
            ...
            <li class="topD">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" placeholder="请输入管理员密码" class="txt" name="password" ></td>
                    </tr>
                    <tr>
                        <td align="right">验证码：</td>
                        <td>
                            <input type="text" placeholder="请输入验证码" class="txt code" name="code">
                            <img src='./code.php' width="60" height="30" onclick="this.src='./code.php?id='+Math.random(0,1)" />
                        </td>
                    </tr>
                    <tr>
