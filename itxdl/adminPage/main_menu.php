...
<!--            <td align="center" valign="middle" class="borderright borderbottom"><input type="text" name="" class="text-word" value="1"></td>-->
            ...
            <td align="center" valign="middle" class="borderright borderbottom"><?=$v['id']?></td>
              ...
              <td align="left" valign="middle" class="borderright borderbottom tdb"><?=$v['status']==1?'开启':'禁用'?></td>
            <td align="center" valign="middle" class="borderbottom">
                <a href="add_menu.php?i=<?=$v['id']?>" target="mainFrame" onFocus="this.blur()" class="add">增加</a><span class="gray">&nbsp;|&nbsp;</span>
                <a href="edit_menu.php?i=<?=$v['id']?>" target="mainFrame" onFocus="this.blur()" class="add">修改</a><span class="gray">&nbsp;|&nbsp;</span>
