...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="header">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="bottom" id="header-name">兄弟连论坛后台管理系统</td>
        <td align="right" valign="top" id="header-right">
        	<a href="doLogout.php" target="topFrame" onFocus="this.blur()" class="admin-out">注销</a>
            <a href="index.php" target="top" onFocus="this.blur()" class="admin-home">后台首页</a>
        	<a href="../userPage/index.php" target="_blank" onFocus="this.blur()" class="admin-index">前台首页</a>
            <span>
<!-- 日历 -->
